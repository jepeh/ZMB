...
*/
    ...
    */
    ...
    /*
    			...
    			"	fresnelTerm = clamp(.9- fresnelTerm, 0., 1.5);",
    			"	gl_FragColor = vec4(color * fresnelTerm, .2);",
    			"}"
    			...
    			var spt = new Three.Mesh(new Three.SphereGeometry(4), new Three.ShaderMaterial({
    				vertexShader: FresnelShader.vertexShader,
    				fragmentShader: FresnelShader.fragmentShader,
    				transparent: true
    			}))
    			
    			spt.position.copy(character.position)
