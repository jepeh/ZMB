...
class Hero {
  ...
  bulletUpdate(time) {
    ...
    for (var b = 0; b < window.droppedCoins.length; b++) {
      ...
      var zBack = this.mesh.position.z - this.size.w / 2,
        zFront = this.mesh.position.z + this.size.w / 2,
        xBack = this.mesh.position.x - this.size.w / 2,
        xFront = this.mesh.position.x + this.size.w / 2;
...
*/
  ...
  self.update = function(p, delta, h) {
    ...
    var zBack = h.position.z - hero.size.w / 2,
      zFront = h.position.z + hero.size.w / 2,
      xBack = h.position.x - hero.size.w / 2,
      xFront = h.position.x + hero.size.w / 2;
...
var EnemyBoss = function() {
  ...
  this.update = function(d) {
    ...
    var zBack = hero.mesh.position.z - hero.size.w / 2,
      zFront = hero.mesh.position.z + hero.size.w / 2,
      xBack = hero.mesh.position.x - hero.size.w / 2,
      xFront = hero.mesh.position.x + hero.size.w / 2;
